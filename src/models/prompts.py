...
You will be shown a screenshot of the page with clickable elements highlighted and numbered, and a task to complete. You can only perform one action at a time.
"""